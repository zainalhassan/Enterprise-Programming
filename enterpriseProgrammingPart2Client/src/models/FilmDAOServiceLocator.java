...
public class FilmDAOServiceLocator extends org.apache.axis.client.Service implements models.FilmDAOService {
    ...
    private java.lang.String FilmDAO_address = "http://localhost:8080/enterpriseProgrammingPart2/services/FilmDAO";
    ...
    public models.FilmDAO getFilmDAO(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            models.FilmDAOSoapBindingStub _stub = new models.FilmDAOSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (models.FilmDAO.class.isAssignableFrom(serviceEndpointInterface)) {
                models.FilmDAOSoapBindingStub _stub = new models.FilmDAOSoapBindingStub(new java.net.URL(FilmDAO_address), this);
                _stub.setPortName(getFilmDAOWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://models", "FilmDAOService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://models", "FilmDAO"));
        }
